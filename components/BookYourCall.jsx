  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row justify-between lg:items-center space-y-12 lg:space-y-0 lg:space-x-16 p-4">
        ...
        <div className="flex-1 items-start justify-start lg:flex-[0.65] w-full">
        ...
        {/* Right Section */}
        <div className="flex-1 lg:flex-[0.35] w-full text-white sm:space-y-32 sm:mt-[450px] ">
          {/* Message Content */}
          <div
            className="flex-1 hidden lg:block p-4 sm:p-6 lg:p-8 bg-opacity-20 bg-gradient-to-b  from-white/30 to-black/40  rounded-2xl shadow-2xl border-2 border-white flex-grow relative"
            // style={{
