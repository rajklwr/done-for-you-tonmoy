  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-6">
        {/* Results Button */}
        <div className="relative group" onClick={() => window.location.href = 'https://tonmoy-yt-landing.vercel.app/results'}>
          <img
        ...
        {/* Life Button */}
        <div className="relative group" onClick={() => window.location.href = 'https://tonmoy-yt-landing.vercel.app/life'}>
          <img
        ...
        {/* Testimonials Button */}
        <div className="relative group" onClick={() => window.location.href = 'https://tonmoy-yt-landing.vercel.app/testimonials'}>
          <img
